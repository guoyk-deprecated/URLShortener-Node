...
var dbHost     = ENV['POSTGRES_HOST']       || ENV['POSTGRES_PORT_5432_TCP_ADDR']       || 'localhost';
var dbPort     = ENV['POSTGRES_PORT']       || ENV['POSTGRES_PORT_5432_TCP_PORT']       || 5432;
var dbUser     = ENV['POSTGRES_USER']       || ENV['POSTGRES_ENV_POSTGRES_USER']        || 'postgres';
var dbPassword = ENV['POSTGRES_PASSWORD']   || ENV['POSTGRES_ENV_POSTGRES_PASSWORD']    || '';
var dbDatabase = ENV['POSTGRES_DATABASE']   || dbUser;
